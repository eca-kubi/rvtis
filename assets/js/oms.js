  ...
  this['OverlappingMarkerSpiderfier'] = (function() {
    ...
    p['markersNearMarker'] = function(marker, firstOnly) {
      ...
      if (this.projHelper.getProjection() == null) {
        console.error("Must wait for 'idle' event on map before calling markersNearMarker");
        return
    ...
    p.markerProximityData = function() {
      ...
      if (this.projHelper.getProjection() == null) {
        console.log("Must wait for 'idle' event on map before calling markersNearAnyOtherMarker")
