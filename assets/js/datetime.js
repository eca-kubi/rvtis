(function() {	
	...
	Spring.datetime.prettyDate = function (time) {
	...
	Spring.datetime.getTwitterInterval = function (strDateTime) {
	    return Spring.datetime.prettyDate(Spring.datetime.strtotime(strDateTime));
	};
	
	Spring.datetime.dayToName = function (day) {
	    switch (day) {
	    case 0:
	        return 'Sunday';
	    case 1:
	...
	Spring.datetime.monthToName = function (month) {
	    switch (month) {
	    case 1:
	        return 'January';
	    case 2:
	...
	Spring.datetime.cleanDate = function (date) {
	    var label;
	    switch (date.getDate()) {
	    case 1:
	        label = 'st';
	    ...
	    return Spring.datetime.dayToName(date.getDay()) + ', ' + Spring.datetime.monthToName(date.getMonth() + 1) + ' ' + date.getDate() + label;
	};
	
	Spring.datetime.cleanTime = function (time) {
